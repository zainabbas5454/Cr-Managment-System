			...
			<div class="wrap-login100">
                ...
                <form method="POST" action="{{ route('login') }}" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input id="email" class="input100 @error('email') is-invalid @enderror" type="email"  name="email" value="{{ old('email') }}" placeholder="Enter email">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input id="password" class="input100 @error('password') is-invalid @enderror" type="password"  name="password" autocomplete="current-password" placeholder="Enter password">
						<span class="focus-input100"></span>
