...
<div class="container">
    ...
    @endforeach
    @endif
    <h1 style="text-align: center;">Post Notification to Class</h1>
    <div class="card mb-5" style="  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
        <div class="card-header">
          Post Notification to class
        </div>
        <div class="card-body">
          <form action="{{route('PostClassNotification')}}" method="POST" enctype="multipart/form-data">
            @csrf
